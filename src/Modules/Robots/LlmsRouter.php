 ...
 * X-Robots-Tag noindex header, and the generated body is cached behind a
 * validator that is bumped on content changes.
 */
final class LlmsRouter {
	 ...
	 * @var LlmsCollector
	 */
	private LlmsCollector $collector;
	 ...
	 * @param LlmsCollector $collector Collector.
	 * @param LlmsSettings  $settings  Settings.
	 */
	public function __construct( LlmsGenerator $generator, LlmsCollector $collector, LlmsSettings $settings ) {
	...
	public function content(): string {
		...
		$markdown = $this->generator->render(
			$this->collector->collect( $this->settings ),
