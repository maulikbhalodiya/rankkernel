...
final class RedirectCache {
	...
	/**
	 * In memory validator string for the current request.
	 *
	 * @var string|null
	 */
	...
	/**
	 * Fetch the current validator string, memoized per request.
	 *
	 * Performance optimization: caches the option read in memory so multiple
	 * get/set cache calls in a single request avoid repeated get_option lookups.
	 *
