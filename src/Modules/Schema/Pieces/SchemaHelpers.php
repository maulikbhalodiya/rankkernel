...
final class SchemaHelpers {
	...
	public static function httpUrl( string $raw ): string {
		...
		$parts = parse_url( $clean ); // phpcs:ignore WordPress.WP.AlternativeFunctions.parse_url_parse_url -- result strictly type checked before use, wp_parse_url would require WordPress loaded.
