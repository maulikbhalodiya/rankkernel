...
final class QaPagePiece implements PieceInterface {
	...
	private static function kses( string $text ): string {
		...
		return strip_tags( $text ); // phpcs:ignore WordPress.WP.AlternativeFunctions.strip_tags_strip_tags -- strip_tags fallback preserves inner text where wp_kses_post and wp_strip_all_tags are unavailable, matching the MetaPayload fallback.
	}
}
