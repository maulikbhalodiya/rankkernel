...
final class ModuleManager {
	...
	public function bootEnabled(): void {
		...
		foreach ( $sorted as $id => $module ) {
			...
			if ( null !== $missing ) {
				 ...
				 */
				do_action( 'rankkernel/module/force_disabled', $key, $missing ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores -- public hook name, part of the plugin API, must stay stable.
				continue;
			}
	 ...
	 *
	 * @param string $id Id.
	 * @return ModuleInterface|null The result.
	 */
