...
class IndexBuilder {
	 ...
	 *
	 * @return TaxonomiesProvider The result.
	 */
	 ...
	 *
	 * @return AuthorsProvider The result.
	 */
	...
	public function getPerPage(): int {
		 ...
		 */
		$perPage = (int) apply_filters( 'rankkernel/sitemap/entries_per_page', $base ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores -- public hook name, part of the plugin API, must stay stable.
