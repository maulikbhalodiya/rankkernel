...
class SitemapCache {
	...
	public function isEnabled(): bool {
		 ...
		 */
		$enabled = apply_filters( 'rankkernel/sitemap/enable_cache', true ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores -- public hook name, part of the plugin API, must stay stable.
	 ...
	 */
	public function onSavePost( int $postId, mixed $post, bool $update ): void { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.FoundAfterLastUsed -- unused parameter required by the WordPress hook signature.
	 ...
	 */
	public function onUserRegister( int $userId ): void { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.Found -- unused parameter required by the WordPress hook signature.
		$this->queueInvalidation( 'global' );
	 ...
	 * @param int $userId User id.
	 */
	public function onDeleteUser( int $userId ): void { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.Found -- unused parameter required by the WordPress hook signature.
		$this->queueInvalidation( 'global' );
		$this->queueInvalidation( 'authors' );
	}
	 ...
	 * @param int $userId User id.
	 */
	public function onProfileUpdate( int $userId ): void { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.Found -- unused parameter required by the WordPress hook signature.
		$this->queueInvalidation( 'global' );
		$this->queueInvalidation( 'authors' );
	}
