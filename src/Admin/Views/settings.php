...
?>
<div class="wrap">
	<h1><?php echo esc_html__( 'RankKernel Settings', 'rankkernel' ); ?></h1>

	<form method="post" action="">
		<?php wp_nonce_field( 'rankkernel_settings' ); ?>

		<h2><?php echo esc_html__( 'Modules', 'rankkernel' ); ?></h2>
		<p class="description"><?php echo esc_html__( 'Visible trail and breadcrumb schema share one trail. Place it with the block, shortcode, or template tag.', 'rankkernel' ); ?></p>
		...
		<h2><?php echo esc_html__( 'Title &amp; Description Templates', 'rankkernel' ); ?></h2>
		<table class="form-table" role="presentation"><tbody>
			<tr>
		...
		<h2><?php echo esc_html__( 'Webmaster Verification', 'rankkernel' ); ?></h2>
		<table class="form-table" role="presentation"><tbody>
		...
		<h2><?php echo esc_html__( 'Breadcrumbs', 'rankkernel' ); ?></h2>
		...
		<h2><?php echo esc_html__( 'Uninstall', 'rankkernel' ); ?></h2>
		<table class="form-table" role="presentation"><tbody>
			<tr>
