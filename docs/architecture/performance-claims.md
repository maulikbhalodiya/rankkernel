...
| Pattern match | 1 cached pattern list read | 0 before response | small active list, bounded by the regex cap | `RedirectRepositoryTest::test_all_patterns_excludes_exact_and_inactive`, `RedirectsMatcherTest` |
