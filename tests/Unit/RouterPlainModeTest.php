...
final class RouterPlainModeTest extends TestCase {
	...
	/**
	 * Test query vars are prefixed only.
	 */
	...
	/**
	 * Test intercept serves plain set var.
	 */
	...
	/**
	 * Test intercept serves plain index var.
	 */
	...
	/**
	 * Test canonical disabled for plain vars.
	 */
	...
	/**
	 * Test sitemap xml redirects to index.
	 */
	public function test_sitemap_xml_redirects_to_index(): void {
		...
		$GLOBALS['wp']          = new \stdClass(); // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited -- test setup swaps the WordPress global, restored in tearDown.
