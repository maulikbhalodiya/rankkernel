...
final class SitemapRobotsDirectiveTest extends TestCase {
    ...
    protected function setUp(): void {
        ...
        Functions\when('current_time')->alias(static fn (string $t, bool $g = false): string => '2026-01-01 00:00:00');
    ...
    public function test_boot_registers_robots_txt_filter(): void {
        ...
        Functions\when('add_filter')->alias(
            static function (string $hook, mixed $cb, int $prio = 10, int $args = 1) use (&$filters): bool {
                $filters[] = [ $hook, $prio ];
