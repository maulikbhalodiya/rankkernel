...
final class SchemaModuleTest extends TestCase {
	...
	/**
	 * Test render emits one script tag with valid json.
	 */
	...
	/**
	 * Test render uses passed context single build.
	 */
	...
	/**
	 * Test render emits nothing for empty graph.
	 */
