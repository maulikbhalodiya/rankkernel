...
final class ModuleManagerTest extends TestCase {
	 ...
	 * @return ModuleInterface The result.
	 */
	...
	/**
	 * Test module off boot never called zero hooks.
	 */
	...
	/**
	 * Test module on boot called exactly once after register.
	 */
	...
	/**
	 * Test depends On enforcement forced off and action fired.
	 */
	...
	/**
	 * Test is On reads cached map get option called once.
	 */
	...
	/**
	 * Test single option read across evaluate and boot with two modules.
	 */
	...
	/**
	 * Test boot order respects priority.
	 */
	...
	/**
	 * Test late registered module boots when enabled.
	 */
	...
	/**
	 * Test late registered module does not boot when disabled.
	 */
	...
	/**
	 * Test enabled modules returns only enabled in priority order.
	 */
