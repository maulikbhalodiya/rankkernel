...
final class SchemaBatch3Test extends TestCase {
	...
	/**
	 * Test type list covers batch3 types.
	 */
	...
	/**
	 * Test product not needed for wrong type or empty name.
	 */
	...
	/**
	 * Test product builds full structure with ids.
	 */
	...
	/**
	 * Test availability mapping with default.
	 */
	...
	/**
	 * Test price and currency validation.
	 */
	...
	public function test_rating_validation(): void {
		$valid = SchemaHelpers::aggregateRating(
			[
				'ratingValue' => '4',
				'reviewCount' => '3',
			]
	...
	/**
	 * Test date normalization drops invalid.
	 */
	...
	/**
	 * Test recipe needed by ingredients without type.
	 */
	...
	/**
	 * Test recipe builds ingredients instructions and durations.
	 */
	...
	/**
	 * Test event needed by start date and gating.
	 */
	...
	/**
	 * Test event builds location status and offers.
	 */
	...
	/**
	 * Test event status mapping and end date rule.
	 */
	...
	/**
	 * Test service builds provider area and offers.
	 */
	...
	/**
	 * Test video requires all google fields.
	 */
	...
	/**
	 * Test video builds duration content and author.
	 */
	...
	/**
	 * Test job posting builds org location salary dates.
	 */
	...
	/**
	 * Test job posting company overrides org and bad dates drop.
	 */
	...
	/**
	 * Test software builds category os offers rating.
	 */
	...
	/**
	 * Test music builds artist and album.
	 */
	...
	/**
	 * Test music omits empty artist and album.
	 */
	...
	/**
	 * Test woo values flow through the seam.
	 */
	...
	/**
	 * Test woo payload overrides win.
	 */
