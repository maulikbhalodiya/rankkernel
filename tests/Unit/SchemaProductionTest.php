...
final class SchemaProductionTest extends TestCase {
	...
	/**
	 * Test sanitize preserves automatic empty type.
	 */
	...
	/**
	 * Test normalize or empty keeps automatic and rejects unknown.
	 */
	...
	/**
	 * Test registry maps every supported type to a piece.
	 */
	...
	/**
	 * Test registry required fields match admin warnings.
	 */
	...
	/**
	 * Test generator registers every registry piece.
	 */
	 ...
	 * @return SettingsStore The result.
	 */
	...
	/**
	 * Test localbusiness builds full node.
	 */
	...
	/**
	 * Test localbusiness not needed without name or wrong type.
	 */
	...
	/**
	 * Test review builds standalone node.
	 */
	...
	/**
	 * Test review rejects non numeric rating.
	 */
	...
	/**
	 * Test imageobject uses url as id with dimensions.
	 */
	...
	/**
	 * Test custom json single typed node merges.
	 */
	...
	/**
	 * Test custom json strips context and wraps typeless.
	 */
	...
	/**
	 * Test custom json graph wrapper and caps.
	 */
	...
	/**
	 * Test custom json malformed shapes are ignored.
	 */
	...
	/**
	 * Test disabled flag suppresses everything including globals.
	 */
	...
	/**
	 * Test disabled filter kills graph.
	 */
	...
	/**
	 * Test single primary for explicit product.
	 */
	...
	/**
	 * Test post type default routes to owning piece.
	 */
	...
	/**
	 * Test person publisher mode matches refs.
	 */
	...
	/**
	 * Test organization mode publisher refs.
	 */
	...
	/**
	 * Test webpage is webpage on front with ispartof.
	 */
	...
	/**
	 * Test webpage has breadcrumb ref on singular.
	 */
	...
	/**
	 * Test person has no empty sameas and honors override.
	 */
	...
	/**
	 * Test singular renders valid single script graph.
	 */
	...
	/**
	 * Test render escapes script breakout.
	 */
	...
	/**
	 * Test home search and 404 contexts.
	 */
	...
	/**
	 * Test product without woo uses fields only.
	 */
	...
	/**
	 * Test missing site name prunes dangling publisher refs.
	 */
	...
	/**
	 * Test webpage name drops dangling separators.
	 */
	...
	/**
	 * Test password protected post emits nothing.
	 */
	...
	/**
	 * Test nested faq block inside group is found.
	 */
	public function test_nested_faq_block_inside_group_is_found(): void {
		Functions\when( 'get_post_field' )->alias(
			static function ( string $field, int $id ): string { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.FoundAfterLastUsed -- stub mirrors the WordPress get_post_field signature.
		...
		Functions\when( 'parse_blocks' )->alias(
			static function ( string $content ): array { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.Found -- stub mirrors the WordPress parse_blocks signature.
				return [
					[
	...
	/**
	 * Test faq block parses content once per instance.
	 */
	public function test_faq_block_parses_content_once_per_instance(): void {
		...
		Functions\when( 'parse_blocks' )->alias(
			static function ( string $content ) use ( &$calls ): array { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.Found -- stub mirrors the WordPress parse_blocks signature.
				++$calls;
