...
final class SchemaSettingsAdminTest extends TestCase {
	...
	protected function setUp(): void {
		...
		Functions\when( 'selected' )->alias(
			static fn ( mixed $a, mixed $b, bool $display = true ): string => (string) $a === (string) $b ? 'selected="selected"' : '' // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.FoundAfterLastUsed, WordPress.CodeAnalysis.AssignmentInTernaryCondition.FoundInTernaryCondition -- stub mirrors the WordPress selected signature; the equals sign is a parameter default, not an assignment in the condition.
		);
	...
	private function makeContext( WP_Query $query, array $overrides = [] ): Context {
		...
		Functions\when( 'get_option' )->alias(
			function ( string $key, mixed $fallback = false ) use ( $stored ): mixed {
	...
	/**
	 * Test new toggle defaults are true.
	 */
	...
	/**
	 * Test valid default type is stored.
	 */
	...
	/**
	 * Test dashed post type slug default is stored.
	 */
	...
	/**
	 * Test invalid default type is dropped never stored.
	 */
	...
	/**
	 * Test empty default type means automatic.
	 */
	...
	/**
	 * Test default for post type mapping.
	 */
	...
	/**
	 * Test article payload type beats setting beats mapping.
	 */
	...
	/**
	 * Test setting routes primary to owning piece for cpt.
	 */
	...
	/**
	 * Test article invalid setting falls back to mapping.
	 */
	...
	/**
	 * Test breadcrumb gated by toggle.
	 */
	...
	/**
	 * Test render shows identity defaults and tools.
	 */
	...
	/**
	 * Test render reflects stored values.
	 */
	...
	/**
	 * Test save drops unknown type value.
	 */
	...
	/**
	 * Test save rejects missing caps.
	 */
	...
	/**
	 * Test block register hooks category and block type.
	 */
	...
	/**
	 * Test schema boot registers block behind enable gate.
	 */
	...
	/**
	 * Test admin only wiring registers nothing outside admin.
	 */
	...
	public function test_admin_wiring_registers_menu_inside_admin(): void {
		...
		Functions\when( 'add_action' )->alias(
			static function ( string $hook, mixed $cb ) use ( &$hooked ): bool { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.FoundAfterLastUsed -- stub mirrors the WordPress add_action signature.
				$hooked[] = $hook;
