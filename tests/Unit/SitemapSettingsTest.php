...
final class SitemapSettingsTest extends TestCase {
	...
	/**
	 * Test set whitelists unknown keys away.
	 */
	...
	/**
	 * Test set only unknown keys saves nothing.
	 */
	...
	/**
	 * Test items per page clamped and cast.
	 */
	...
	/**
	 * Test id lists absint filtered and unique.
	 */
	...
	/**
	 * Test id lists accept comma string.
	 */
	...
	/**
	 * Test dynamic keys accepted others dropped.
	 */
	...
	/**
	 * Test is type enabled true when absent.
	 */
