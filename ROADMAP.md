...
| Next | Phase 2 → XML Sitemaps (issue #6) |
...
| 1.6 | Metadata Engine: single meta key (1 query vs their 25–45), memoized tokens, single-pass head | ≤1-meta-query test |
...
### 2.1 XML Sitemaps ⬜ — next (issue will be #6)
...
| 7.5 | SVN submission via wp.org account `maulikbhalodiya` + review replies (5–14 business days) |
